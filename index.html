...
<div>
  ...
  <section>
    ...
    <ul>
      ...
      <li>m-learning activity: A learning activit designed for use with mobile phones or other hand-held devices</li>
      <li>Virtual field trip: A virtual tour using multiple Web pages and multimediato guide learners through an online visit to a remote destination</li>
      <li>WebQuest: A higher-order thinking activity that integrates online resources. Multiple Web pages and CSS menu are used to create this project </li>
    </ul>
  </section>
  <footer><img src="valid_html5_blue.png" width="80" height="15" alt=""/>&copy; 2020(#13)</footer>
</div>
</body>
</html>
